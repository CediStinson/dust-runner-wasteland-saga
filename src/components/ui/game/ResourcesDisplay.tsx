...
const ResourcesDisplay: React.FC<ResourcesDisplayProps> = ({
  ...
  return (
    <div className="flex gap-3">
      {/* Metal resources */}
      <div className="bg-black/50 p-2.5 rounded-lg backdrop-blur-sm text-yellow-200 border border-yellow-500/30">
        <div className="flex gap-2 items-center">
          <div className="w-5 h-5 bg-gray-400 rounded-sm border border-gray-300 flex items-center justify-center">
            <div className="w-3.5 h-1 bg-gray-300"></div>
          </div>
      ...
      {/* Copper resources */}
      <div className="bg-black/50 p-2.5 rounded-lg backdrop-blur-sm text-orange-200 border border-orange-500/30">
        <div className="flex gap-2 items-center">
